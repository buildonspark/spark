...
func TestRenewNodeZeroTimelock(t *testing.T) {
	...
	modifyNodeTimelockAllOperators(t, config, rootNode.Id, 0, 200)
...
func TestRenewNodeTimelock(t *testing.T) {
	...
	// Now the leaf has a parent (the split node). Mock node_tx (currently 0) and refund_tx (currently 2000) both to 200 to trigger RenewNodeTimelock.
	modifyNodeTimelockAllOperators(t, config, leafAfterZeroRenew.Id, 200, 200)
...
func TestRenewRefundTimelock(t *testing.T) {
	...
	modifyNodeTimelockAllOperators(t, config, renewedLeaf.Id, 200, 200)
	...
	modifyNodeTimelockAllOperators(t, config, renewedLeaf2.Id, 2000, 200)
