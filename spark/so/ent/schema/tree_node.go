...
func (TreeNode) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Bytes("raw_txid").Optional().GoType(st.TxID{}).Comment("Valid transaction ID of the stored node transaction. Generated by hooks from raw_tx."),
		field.Bytes("direct_txid").Optional().GoType(st.TxID{}).Comment("Valid transaction ID of the stored direct node transaction. Generated by hooks from direct_tx."),
		field.Bytes("direct_from_cpfp_refund_txid").Optional().GoType(st.TxID{}).Comment("Valid transaction ID of the stored direct from CPFP node transaction. Generated by hooks from direct_from_cpfp_refund_tx."),
		...
		field.Bytes("raw_refund_txid").Optional().GoType(st.TxID{}).Comment("Valid transaction ID of the stored refund transaction. Generated by hooks from raw_refund_tx."),
		field.Bytes("direct_refund_txid").Optional().GoType(st.TxID{}).Comment("Valid transaction ID of the direct refund transaction. Generated by hooks from direct_refund_tx."),
	}
}
