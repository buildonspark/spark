...
func (TokenFreeze) Indexes() []ent.Index {
	return []ent.Index{
		...
		index.Fields("owner_public_key", "token_public_key", "wallet_provided_freeze_timestamp").
			Unique().
			StorageKey("tokenfreeze_owner_public_key_token_public_key_wallet_provided_f"),
		index.Fields("owner_public_key", "token_public_key", "wallet_provided_thaw_timestamp").
			Unique().
