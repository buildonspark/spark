...
func StatusValidator(s schematype.TransferReceiverStatus) error {
	switch s {
	case "INITIATED", "PENDING_RECEIVER_CLAIM", "RECEIVER_KEY_TWEAKED", "RECEIVER_KEY_TWEAK_LOCKED", "RECEIVER_KEY_TWEAK_APPLIED", "RECEIVER_REFUND_SIGNED", "COMPLETED", "CANCELLED":
		return nil
	default:
