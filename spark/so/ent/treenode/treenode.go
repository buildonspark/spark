...
func StatusValidator(s schematype.TreeNodeStatus) error {
	switch s {
	case "CREATING", "AVAILABLE", "FROZEN_BY_ISSUER", "TRANSFER_LOCKED", "SPLIT_LOCKED", "SPLITTED", "AGGREGATED", "ON_CHAIN", "AGGREGATE_LOCK", "EXITED", "INVESTIGATION", "LOST", "REIMBURSED", "PARENT_EXITED", "RENEW_LOCKED", "CONSOLIDATED", "WATCHTOWER_EXITED", "WATCHTOWER_EXIT_RECOVERED":
		return nil
	default:
