...
CREATE TABLE "preimage_requests" ("id" uuid NOT NULL, "create_time" timestamptz NOT NULL, "update_time" timestamptz NOT NULL, "payment_hash" bytea NOT NULL, "status" character varying NOT NULL, "preimage_request_transfers" uuid NULL, PRIMARY KEY ("id"));
-- Create index "preimage_requests_payment_hash_key" to table: "preimage_requests"
CREATE UNIQUE INDEX "preimage_requests_payment_hash_key" ON "preimage_requests" ("payment_hash");
...
ALTER TABLE "token_leafs" ADD CONSTRAINT "token_leafs_signing_keyshares_revocation_keyshare" FOREIGN KEY ("token_leaf_revocation_keyshare") REFERENCES "signing_keyshares" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION, ADD CONSTRAINT "token_leafs_token_transaction_receipts_leaf_created_token_trans" FOREIGN KEY ("token_leaf_leaf_created_token_transaction_receipt") REFERENCES "token_transaction_receipts" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, ADD CONSTRAINT "token_leafs_token_transaction_receipts_leaf_spent_token_transac" FOREIGN KEY ("token_leaf_leaf_spent_token_transaction_receipt") REFERENCES "token_transaction_receipts" ("id") ON UPDATE NO ACTION ON DELETE SET NULL;
