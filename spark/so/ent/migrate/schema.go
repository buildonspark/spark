...
var (
	...
	TokenAllowancesColumns = []*schema.Column{
		...
		{Name: "revoke_version", Type: field.TypeUint64, Nullable: true},
	...
	TransferLeafsColumns = []*schema.Column{
		...
		{Name: "signature_scheme", Type: field.TypeInt32, Nullable: true},
	...
	TransferLeafsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{TransferLeafsColumns[24]},
	...
	TreesColumns = []*schema.Column{
		...
		{Name: "update_time", Type: field.TypeTime},
		{Name: "owner_identity_pubkey", Type: field.TypeBytes},
		{Name: "status", Type: field.TypeEnum, Enums: []string{"PENDING", "AVAILABLE", "EXITED", "CREATION_ABANDONED"}},
		{Name: "network", Type: field.TypeEnum, Enums: []string{"UNSPECIFIED", "MAINNET", "REGTEST", "TESTNET", "SIGNET"}},
	...
	TreeNodesColumns = []*schema.Column{
		...
		{Name: "network", Type: field.TypeEnum, Enums: []string{"UNSPECIFIED", "MAINNET", "REGTEST", "TESTNET", "SIGNET"}},
		{Name: "status", Type: field.TypeEnum, Enums: []string{"CREATING", "AVAILABLE", "FROZEN_BY_ISSUER", "TRANSFER_LOCKED", "SPLIT_LOCKED", "SPLITTED", "AGGREGATED", "ON_CHAIN", "AGGREGATE_LOCK", "EXITED", "INVESTIGATION", "LOST", "REIMBURSED", "PARENT_EXITED", "RENEW_LOCKED", "CONSOLIDATED", "WATCHTOWER_EXITED", "WATCHTOWER_EXIT_RECOVERED", "CREATION_ABANDONED"}},
	...
	TreeNodesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "treenode_status_network_update_time_create_time_parent",
				Unique:  false,
				Columns: []*schema.Column{TreeNodesColumns[5], TreeNodesColumns[4], TreeNodesColumns[2], TreeNodesColumns[1], TreeNodesColumns[23]},
			},
			{
