...
var file_spark_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x65, 0x22, 0x83, 0x02, 0x0a, 0x08, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72,
	0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x19, 0x72, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x72,
	0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65,
	0x79, 0x12, 0x2d, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x56, 0x61, 0x6c, 0x75,
	0x65, 0x12, 0x3b, 0x0a, 0x0b, 0x65, 0x78, 0x70, 0x69, 0x72, 0x79, 0x5f, 0x74, 0x69, 0x6d, 0x65,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61,
	0x6d, 0x70, 0x52, 0x0a, 0x65, 0x78, 0x70, 0x69, 0x72, 0x79, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x19,
	0x0a, 0x08, 0x6c, 0x65, 0x61, 0x66, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x07, 0x6c, 0x65, 0x61, 0x66, 0x49, 0x64, 0x73, 0x22, 0x43, 0x0a, 0x14, 0x53, 0x65, 0x6e,
	...
	0x9a, 0x02, 0x0a, 0x11, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x4c, 0x65, 0x61, 0x66, 0x4b, 0x65, 0x79,
	...
	0x1c, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x54, 0x77,
	0x65, 0x61, 0x6b, 0x4b, 0x65, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1f, 0x0a,
	...
	0x6c, 0x65, 0x61, 0x76, 0x65, 0x73, 0x54, 0x6f, 0x52, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x2a,
	...
	0x53, 0x5f, 0x45, 0x58, 0x50, 0x49, 0x52, 0x45, 0x44, 0x10, 0x03, 0x32, 0xf4, 0x05, 0x0a, 0x0c,
...
var file_spark_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_spark_proto_goTypes = []any{
	...
	(*ClaimLeafKeyTweak)(nil),              // 27: spark.ClaimLeafKeyTweak
	(*ClaimTransferTweakKeyRequest)(nil),   // 28: spark.ClaimTransferTweakKeyRequest
	nil,                                    // 29: spark.SigningResult.PublicKeysEntry
	nil,                                    // 30: spark.SigningResult.SigningNonceCommitmentsEntry
	nil,                                    // 31: spark.SigningResult.SignatureSharesEntry
	nil,                                    // 32: spark.SendLeafKeyTweak.PubkeySharesTweakEntry
	nil,                                    // 33: spark.ClaimLeafKeyTweak.PubkeySharesTweakEntry
	(*common.SigningCommitment)(nil),       // 34: common.SigningCommitment
	(common.SignatureIntent)(0),            // 35: common.SignatureIntent
...
var file_spark_proto_depIdxs = []int32{
	...
	34, // 1: spark.SigningJob.signing_nonce_commitment:type_name -> common.SigningCommitment
	29, // 2: spark.SigningResult.public_keys:type_name -> spark.SigningResult.PublicKeysEntry
	30, // 3: spark.SigningResult.signing_nonce_commitments:type_name -> spark.SigningResult.SigningNonceCommitmentsEntry
	31, // 4: spark.SigningResult.signature_shares:type_name -> spark.SigningResult.SignatureSharesEntry
	...
	35, // 17: spark.FinalizeNodeSignaturesRequest.intent:type_name -> common.SignatureIntent
	...
	32, // 22: spark.SendLeafKeyTweak.pubkey_shares_tweak:type_name -> spark.SendLeafKeyTweak.PubkeySharesTweakEntry
	21, // 23: spark.SendTransferRequest.leaves_to_send:type_name -> spark.SendLeafKeyTweak
	36, // 24: spark.SendTransferRequest.expiry_time:type_name -> google.protobuf.Timestamp
	0,  // 25: spark.Transfer.status:type_name -> spark.TransferStatus
	36, // 26: spark.Transfer.expiry_time:type_name -> google.protobuf.Timestamp
	...
	20, // 29: spark.ClaimLeafKeyTweak.secret_share_tweak:type_name -> spark.SecretShareTweak
	33, // 30: spark.ClaimLeafKeyTweak.pubkey_shares_tweak:type_name -> spark.ClaimLeafKeyTweak.PubkeySharesTweakEntry
	27, // 31: spark.ClaimTransferTweakKeyRequest.leaves_to_receive:type_name -> spark.ClaimLeafKeyTweak
	34, // 32: spark.SigningResult.SigningNonceCommitmentsEntry.value:type_name -> common.SigningCommitment
	1,  // 33: spark.SparkService.generate_deposit_address:input_type -> spark.GenerateDepositAddressRequest
	9,  // 34: spark.SparkService.start_tree_creation:input_type -> spark.StartTreeCreationRequest
	18, // 35: spark.SparkService.prepare_split_address:input_type -> spark.PrepareSplitAddressRequest
	13, // 36: spark.SparkService.split_node:input_type -> spark.SplitNodeRequest
	16, // 37: spark.SparkService.finalize_node_signatures:input_type -> spark.FinalizeNodeSignaturesRequest
	22, // 38: spark.SparkService.send_transfer:input_type -> spark.SendTransferRequest
	25, // 39: spark.SparkService.query_pending_transfers:input_type -> spark.QueryPendingTransfersRequest
	28, // 40: spark.SparkService.claim_transfer_tweak_key:input_type -> spark.ClaimTransferTweakKeyRequest
	3,  // 41: spark.SparkService.generate_deposit_address:output_type -> spark.GenerateDepositAddressResponse
	10, // 42: spark.SparkService.start_tree_creation:output_type -> spark.StartTreeCreationResponse
	19, // 43: spark.SparkService.prepare_split_address:output_type -> spark.PrepareSplitAddressResponse
	15, // 44: spark.SparkService.split_node:output_type -> spark.SplitNodeResponse
	17, // 45: spark.SparkService.finalize_node_signatures:output_type -> spark.FinalizeNodeSignaturesResponse
	24, // 46: spark.SparkService.send_transfer:output_type -> spark.SendTransferResponse
	26, // 47: spark.SparkService.query_pending_transfers:output_type -> spark.QueryPendingTransfersResponse
	37, // 48: spark.SparkService.claim_transfer_tweak_key:output_type -> google.protobuf.Empty
