...
var file_spark_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x6c, 0x65, 0x61, 0x76, 0x65, 0x73, 0x22, 0x81, 0x01, 0x0a, 0x0c, 0x54, 0x72, 0x61,
	0x6e, 0x73, 0x66, 0x65, 0x72, 0x4c, 0x65, 0x61, 0x66, 0x12, 0x17, 0x0a, 0x07, 0x6c, 0x65, 0x61,
	0x66, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6c, 0x65, 0x61, 0x66,
	0x49, 0x64, 0x12, 0x23, 0x0a, 0x0d, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x5f, 0x63, 0x69, 0x70,
	...
	0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x15, 0x0a, 0x06, 0x72, 0x61, 0x77, 0x5f, 0x74, 0x78, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x72, 0x61, 0x77, 0x54, 0x78, 0x22, 0x43, 0x0a, 0x14,
...
var file_spark_proto_msgTypes = make([]protoimpl.MessageInfo, 40)
var file_spark_proto_goTypes = []any{
	...
	(*ClaimLeafSigningJob)(nil),              // 30: spark.ClaimLeafSigningJob
	(*ClaimTransferSignRefundsRequest)(nil),  // 31: spark.ClaimTransferSignRefundsRequest
	(*ClaimLeafSigningResult)(nil),           // 32: spark.ClaimLeafSigningResult
	(*ClaimTransferSignRefundsResponse)(nil), // 33: spark.ClaimTransferSignRefundsResponse
	(*AggregateNodesRequest)(nil),            // 34: spark.AggregateNodesRequest
	(*AggregateNodesResponse)(nil),           // 35: spark.AggregateNodesResponse
	nil,                                      // 36: spark.SigningResult.PublicKeysEntry
	nil,                                      // 37: spark.SigningResult.SigningNonceCommitmentsEntry
	nil,                                      // 38: spark.SigningResult.SignatureSharesEntry
	nil,                                      // 39: spark.SendLeafKeyTweak.PubkeySharesTweakEntry
	nil,                                      // 40: spark.ClaimLeafKeyTweak.PubkeySharesTweakEntry
	(*common.SigningCommitment)(nil),         // 41: common.SigningCommitment
	(common.SignatureIntent)(0),              // 42: common.SignatureIntent
...
var file_spark_proto_depIdxs = []int32{
	...
	41, // 1: spark.SigningJob.signing_nonce_commitment:type_name -> common.SigningCommitment
	36, // 2: spark.SigningResult.public_keys:type_name -> spark.SigningResult.PublicKeysEntry
	37, // 3: spark.SigningResult.signing_nonce_commitments:type_name -> spark.SigningResult.SigningNonceCommitmentsEntry
	38, // 4: spark.SigningResult.signature_shares:type_name -> spark.SigningResult.SignatureSharesEntry
	...
	42, // 17: spark.FinalizeNodeSignaturesRequest.intent:type_name -> common.SignatureIntent
	...
	39, // 22: spark.SendLeafKeyTweak.pubkey_shares_tweak:type_name -> spark.SendLeafKeyTweak.PubkeySharesTweakEntry
	21, // 23: spark.SendTransferRequest.leaves_to_send:type_name -> spark.SendLeafKeyTweak
	43, // 24: spark.SendTransferRequest.expiry_time:type_name -> google.protobuf.Timestamp
	0,  // 25: spark.Transfer.status:type_name -> spark.TransferStatus
	43, // 26: spark.Transfer.expiry_time:type_name -> google.protobuf.Timestamp
	...
	40, // 31: spark.ClaimLeafKeyTweak.pubkey_shares_tweak:type_name -> spark.ClaimLeafKeyTweak.PubkeySharesTweakEntry
	28, // 32: spark.ClaimTransferTweakKeysRequest.leaves_to_receive:type_name -> spark.ClaimLeafKeyTweak
	5,  // 33: spark.ClaimLeafSigningJob.refund_tx_signing_job:type_name -> spark.SigningJob
	30, // 34: spark.ClaimTransferSignRefundsRequest.signing_jobs:type_name -> spark.ClaimLeafSigningJob
	6,  // 35: spark.ClaimLeafSigningResult.refund_tx_signing_result:type_name -> spark.SigningResult
	32, // 36: spark.ClaimTransferSignRefundsResponse.signing_results:type_name -> spark.ClaimLeafSigningResult
	5,  // 37: spark.AggregateNodesRequest.signing_job:type_name -> spark.SigningJob
	6,  // 38: spark.AggregateNodesResponse.aggregate_signature:type_name -> spark.SigningResult
	41, // 39: spark.SigningResult.SigningNonceCommitmentsEntry.value:type_name -> common.SigningCommitment
	1,  // 40: spark.SparkService.generate_deposit_address:input_type -> spark.GenerateDepositAddressRequest
	9,  // 41: spark.SparkService.start_tree_creation:input_type -> spark.StartTreeCreationRequest
	18, // 42: spark.SparkService.prepare_split_address:input_type -> spark.PrepareSplitAddressRequest
	13, // 43: spark.SparkService.split_node:input_type -> spark.SplitNodeRequest
	16, // 44: spark.SparkService.finalize_node_signatures:input_type -> spark.FinalizeNodeSignaturesRequest
	22, // 45: spark.SparkService.send_transfer:input_type -> spark.SendTransferRequest
	26, // 46: spark.SparkService.query_pending_transfers:input_type -> spark.QueryPendingTransfersRequest
	29, // 47: spark.SparkService.claim_transfer_tweak_keys:input_type -> spark.ClaimTransferTweakKeysRequest
	31, // 48: spark.SparkService.claim_transfer_sign_refunds:input_type -> spark.ClaimTransferSignRefundsRequest
	34, // 49: spark.SparkService.aggregate_nodes:input_type -> spark.AggregateNodesRequest
	3,  // 50: spark.SparkService.generate_deposit_address:output_type -> spark.GenerateDepositAddressResponse
	10, // 51: spark.SparkService.start_tree_creation:output_type -> spark.StartTreeCreationResponse
	19, // 52: spark.SparkService.prepare_split_address:output_type -> spark.PrepareSplitAddressResponse
	15, // 53: spark.SparkService.split_node:output_type -> spark.SplitNodeResponse
	17, // 54: spark.SparkService.finalize_node_signatures:output_type -> spark.FinalizeNodeSignaturesResponse
	25, // 55: spark.SparkService.send_transfer:output_type -> spark.SendTransferResponse
	27, // 56: spark.SparkService.query_pending_transfers:output_type -> spark.QueryPendingTransfersResponse
	44, // 57: spark.SparkService.claim_transfer_tweak_keys:output_type -> google.protobuf.Empty
	33, // 58: spark.SparkService.claim_transfer_sign_refunds:output_type -> spark.ClaimTransferSignRefundsResponse
	35, // 59: spark.SparkService.aggregate_nodes:output_type -> spark.AggregateNodesResponse
