...
var file_spark_proto_rawDesc = []byte{
	...
	,
	...
	0x22, 0x00, 0x12, 0x59, 0x0a, 0x18, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x5f, 0x74, 0x72, 0x61, 0x6e,
	0x73, 0x66, 0x65, 0x72, 0x5f, 0x74, 0x77, 0x65, 0x61, 0x6b, 0x5f, 0x6b, 0x65, 0x79, 0x12, 0x23,
	0x2e, 0x73, 0x70, 0x61, 0x72, 0x6b, 0x2e, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x54, 0x72, 0x61, 0x6e,
	0x73, 0x66, 0x65, 0x72, 0x54, 0x77, 0x65, 0x61, 0x6b, 0x4b, 0x65, 0x79, 0x52, 0x65, 0x71, 0x75,
...
var file_spark_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
var file_spark_proto_goTypes = []any{
	...
	nil,                                    // 30: spark.SigningResult.PublicKeysEntry
	nil,                                    // 31: spark.SigningResult.SigningNonceCommitmentsEntry
	nil,                                    // 32: spark.SigningResult.SignatureSharesEntry
	nil,                                    // 33: spark.SendLeafKeyTweak.PubkeySharesTweakEntry
	nil,                                    // 34: spark.ClaimLeafKeyTweak.PubkeySharesTweakEntry
	(*common.SigningCommitment)(nil),       // 35: common.SigningCommitment
	(common.SignatureIntent)(0),            // 36: common.SignatureIntent
...
var file_spark_proto_depIdxs = []int32{
	...
	35, // 1: spark.SigningJob.signing_nonce_commitment:type_name -> common.SigningCommitment
	30, // 2: spark.SigningResult.public_keys:type_name -> spark.SigningResult.PublicKeysEntry
	31, // 3: spark.SigningResult.signing_nonce_commitments:type_name -> spark.SigningResult.SigningNonceCommitmentsEntry
	32, // 4: spark.SigningResult.signature_shares:type_name -> spark.SigningResult.SignatureSharesEntry
	...
	36, // 17: spark.FinalizeNodeSignaturesRequest.intent:type_name -> common.SignatureIntent
	...
	33, // 22: spark.SendLeafKeyTweak.pubkey_shares_tweak:type_name -> spark.SendLeafKeyTweak.PubkeySharesTweakEntry
	21, // 23: spark.SendTransferRequest.leaves_to_send:type_name -> spark.SendLeafKeyTweak
	37, // 24: spark.SendTransferRequest.expiry_time:type_name -> google.protobuf.Timestamp
	0,  // 25: spark.Transfer.status:type_name -> spark.TransferStatus
	37, // 26: spark.Transfer.expiry_time:type_name -> google.protobuf.Timestamp
	...
	34, // 31: spark.ClaimLeafKeyTweak.pubkey_shares_tweak:type_name -> spark.ClaimLeafKeyTweak.PubkeySharesTweakEntry
	28, // 32: spark.ClaimTransferTweakKeyRequest.leaves_to_receive:type_name -> spark.ClaimLeafKeyTweak
	35, // 33: spark.SigningResult.SigningNonceCommitmentsEntry.value:type_name -> common.SigningCommitment
	1,  // 34: spark.SparkService.generate_deposit_address:input_type -> spark.GenerateDepositAddressRequest
	9,  // 35: spark.SparkService.start_tree_creation:input_type -> spark.StartTreeCreationRequest
	18, // 36: spark.SparkService.prepare_split_address:input_type -> spark.PrepareSplitAddressRequest
	13, // 37: spark.SparkService.split_node:input_type -> spark.SplitNodeRequest
	16, // 38: spark.SparkService.finalize_node_signatures:input_type -> spark.FinalizeNodeSignaturesRequest
	22, // 39: spark.SparkService.send_transfer:input_type -> spark.SendTransferRequest
	26, // 40: spark.SparkService.query_pending_transfers:input_type -> spark.QueryPendingTransfersRequest
	29, // 41: spark.SparkService.claim_transfer_tweak_key:input_type -> spark.ClaimTransferTweakKeyRequest
	3,  // 42: spark.SparkService.generate_deposit_address:output_type -> spark.GenerateDepositAddressResponse
	10, // 43: spark.SparkService.start_tree_creation:output_type -> spark.StartTreeCreationResponse
	19, // 44: spark.SparkService.prepare_split_address:output_type -> spark.PrepareSplitAddressResponse
	15, // 45: spark.SparkService.split_node:output_type -> spark.SplitNodeResponse
	17, // 46: spark.SparkService.finalize_node_signatures:output_type -> spark.FinalizeNodeSignaturesResponse
	25, // 47: spark.SparkService.send_transfer:output_type -> spark.SendTransferResponse
	27, // 48: spark.SparkService.query_pending_transfers:output_type -> spark.QueryPendingTransfersResponse
	38, // 49: spark.SparkService.claim_transfer_tweak_key:output_type -> google.protobuf.Empty
