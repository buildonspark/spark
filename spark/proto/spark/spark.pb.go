...
var file_spark_proto_rawDesc = []byte{
	...
	0x73, 0x2a, 0x89, 0x01, 0x0a, 0x0e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x53, 0x74,
	...
	0x44, 0x10, 0x00, 0x12, 0x1d, 0x0a, 0x19, 0x54, 0x52, 0x41, 0x4e, 0x53, 0x46, 0x45, 0x52, 0x5f,
	0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x43, 0x4f, 0x4d, 0x50, 0x4c, 0x45, 0x54, 0x45, 0x44,
	0x10, 0x01, 0x12, 0x1c, 0x0a, 0x18, 0x54, 0x52, 0x41, 0x4e, 0x53, 0x46, 0x45, 0x52, 0x5f, 0x53,
	0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x43, 0x4c, 0x41, 0x49, 0x4d, 0x49, 0x4e, 0x47, 0x10, 0x02,
	0x12, 0x1b, 0x0a, 0x17, 0x54, 0x52, 0x41, 0x4e, 0x53, 0x46, 0x45, 0x52, 0x5f, 0x53, 0x54, 0x41,
	0x54, 0x55, 0x53, 0x5f, 0x45, 0x58, 0x50, 0x49, 0x52, 0x45, 0x44, 0x10, 0x03, 0x32, 0x99, 0x05,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x60, 0x0a, 0x15, 0x70, 0x72, 0x65, 0x70, 0x61, 0x72, 0x65,
	0x5f, 0x73, 0x70, 0x6c, 0x69, 0x74, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x21,
	...
	0x74, 0x1a, 0x22, 0x2e, 0x73, 0x70, 0x61, 0x72, 0x6b, 0x2e, 0x50, 0x72, 0x65, 0x70, 0x61, 0x72,
	0x65, 0x53, 0x70, 0x6c, 0x69, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x52, 0x65, 0x73,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x4a, 0x0a, 0x0d, 0x73, 0x65, 0x6e, 0x64, 0x5f, 0x74, 0x72,
	0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x12, 0x1a, 0x2e, 0x73, 0x70, 0x61, 0x72, 0x6b, 0x2e, 0x53,
	0x65, 0x6e, 0x64, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x73, 0x70, 0x61, 0x72, 0x6b, 0x2e, 0x53, 0x65, 0x6e, 0x64, 0x54,
...
var file_spark_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_spark_proto_goTypes = []any{
	...
	(*QueryPendingTransfersRequest)(nil),   // 25: spark.QueryPendingTransfersRequest
	(*QueryPendingTransfersResponse)(nil),  // 26: spark.QueryPendingTransfersResponse
	nil,                                    // 27: spark.SigningResult.PublicKeysEntry
	nil,                                    // 28: spark.SigningResult.SigningNonceCommitmentsEntry
	nil,                                    // 29: spark.SigningResult.SignatureSharesEntry
	nil,                                    // 30: spark.LeafTransferRequest.PubkeySharesTweakEntry
	(*common.SigningCommitment)(nil),       // 31: common.SigningCommitment
	(common.SignatureIntent)(0),            // 32: common.SignatureIntent
...
var file_spark_proto_depIdxs = []int32{
	...
	31, // 1: spark.SigningJob.signing_nonce_commitment:type_name -> common.SigningCommitment
	27, // 2: spark.SigningResult.public_keys:type_name -> spark.SigningResult.PublicKeysEntry
	28, // 3: spark.SigningResult.signing_nonce_commitments:type_name -> spark.SigningResult.SigningNonceCommitmentsEntry
	29, // 4: spark.SigningResult.signature_shares:type_name -> spark.SigningResult.SignatureSharesEntry
	...
	32, // 17: spark.FinalizeNodeSignaturesRequest.intent:type_name -> common.SignatureIntent
	...
	30, // 22: spark.LeafTransferRequest.pubkey_shares_tweak:type_name -> spark.LeafTransferRequest.PubkeySharesTweakEntry
	21, // 23: spark.SendTransferRequest.tranfers:type_name -> spark.LeafTransferRequest
	33, // 24: spark.SendTransferRequest.expiry_time:type_name -> google.protobuf.Timestamp
	0,  // 25: spark.Transfer.status:type_name -> spark.TransferStatus
	33, // 26: spark.Transfer.expiry_time:type_name -> google.protobuf.Timestamp
	23, // 27: spark.SendTransferResponse.transfer:type_name -> spark.Transfer
	23, // 28: spark.QueryPendingTransfersResponse.transfers:type_name -> spark.Transfer
	31, // 29: spark.SigningResult.SigningNonceCommitmentsEntry.value:type_name -> common.SigningCommitment
	1,  // 30: spark.SparkService.generate_deposit_address:input_type -> spark.GenerateDepositAddressRequest
	9,  // 31: spark.SparkService.start_tree_creation:input_type -> spark.StartTreeCreationRequest
	18, // 32: spark.SparkService.prepare_split_address:input_type -> spark.PrepareSplitAddressRequest
	13, // 33: spark.SparkService.split_node:input_type -> spark.SplitNodeRequest
	16, // 34: spark.SparkService.finalize_node_signatures:input_type -> spark.FinalizeNodeSignaturesRequest
	22, // 35: spark.SparkService.send_transfer:input_type -> spark.SendTransferRequest
	25, // 36: spark.SparkService.query_pending_transfers:input_type -> spark.QueryPendingTransfersRequest
	3,  // 37: spark.SparkService.generate_deposit_address:output_type -> spark.GenerateDepositAddressResponse
	10, // 38: spark.SparkService.start_tree_creation:output_type -> spark.StartTreeCreationResponse
	19, // 39: spark.SparkService.prepare_split_address:output_type -> spark.PrepareSplitAddressResponse
	15, // 40: spark.SparkService.split_node:output_type -> spark.SplitNodeResponse
	17, // 41: spark.SparkService.finalize_node_signatures:output_type -> spark.FinalizeNodeSignaturesResponse
	24, // 42: spark.SparkService.send_transfer:output_type -> spark.SendTransferResponse
	26, // 43: spark.SparkService.query_pending_transfers:output_type -> spark.QueryPendingTransfersResponse
