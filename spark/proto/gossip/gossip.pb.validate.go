...
func (m *GossipMessage) validate(all bool) error {
	...
	case *GossipMessage_UnlockLeafFromRenewal:
		if v == nil {
			err := GossipMessageValidationError{
				field:  "Message",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			switch v := interface{}(m.GetUnlockLeafFromRenewal()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GossipMessageValidationError{
						field:  "UnlockLeafFromRenewal",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetUnlockLeafFromRenewal()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return GossipMessageValidationError{
					field:  "UnlockLeafFromRenewal",
					reason: "embedded message failed validation",
...
// Validate checks the field values on GossipMessageUnlockLeafFromRenewal with
// the rules defined in the proto definition for this message. If any rules
// are violated, the first error encountered is returned, or nil if there are
// no violations.
func (m *GossipMessageUnlockLeafFromRenewal) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GossipMessageUnlockLeafFromRenewal
// with the rules defined in the proto definition for this message. If any
// rules are violated, the result is a list of violation errors wrapped in
// GossipMessageUnlockLeafFromRenewalMultiError, or nil if none found.
func (m *GossipMessageUnlockLeafFromRenewal) ValidateAll() error {
	return m.validate(true)
}

func (m *GossipMessageUnlockLeafFromRenewal) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GossipMessageUnlockLeafFromRenewalMultiError(errors)
	}

	return nil
}

// GossipMessageUnlockLeafFromRenewalMultiError is an error wrapping multiple
// validation errors returned by
// GossipMessageUnlockLeafFromRenewal.ValidateAll() if the designated
// constraints aren't met.
type GossipMessageUnlockLeafFromRenewalMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GossipMessageUnlockLeafFromRenewalMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GossipMessageUnlockLeafFromRenewalMultiError) AllErrors() []error { return m }

// GossipMessageUnlockLeafFromRenewalValidationError is the validation error
// returned by GossipMessageUnlockLeafFromRenewal.Validate if the designated
// constraints aren't met.
type GossipMessageUnlockLeafFromRenewalValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GossipMessageUnlockLeafFromRenewalValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GossipMessageUnlockLeafFromRenewalValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GossipMessageUnlockLeafFromRenewalValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GossipMessageUnlockLeafFromRenewalValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GossipMessageUnlockLeafFromRenewalValidationError) ErrorName() string {
	return "GossipMessageUnlockLeafFromRenewalValidationError"
}

// Error satisfies the builtin error interface
func (e GossipMessageUnlockLeafFromRenewalValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGossipMessageUnlockLeafFromRenewal.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GossipMessageUnlockLeafFromRenewalValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GossipMessageUnlockLeafFromRenewalValidationError{}
