...
func (c *sparkAuthnServiceClient) GetChallenge(ctx context.Context, in *GetChallengeRequest, opts ...grpc.CallOption) (*GetChallengeResponse, error) {
	...
	err := c.cc.Invoke(ctx, SparkAuthnService_GetChallenge_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sparkAuthnServiceClient) VerifyChallenge(ctx context.Context, in *VerifyChallengeRequest, opts ...grpc.CallOption) (*VerifyChallengeResponse, error) {
	...
	err := c.cc.Invoke(ctx, SparkAuthnService_VerifyChallenge_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSparkAuthnServiceServer must be embedded to have forward compatible implementations.
