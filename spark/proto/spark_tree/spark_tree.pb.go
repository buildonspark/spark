...
type FetchPolarityScore struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *FetchPolarityScore) Reset() {
	*x = FetchPolarityScore{}
	mi := &file_spark_tree_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *FetchPolarityScore) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FetchPolarityScore) ProtoMessage() {}

func (x *FetchPolarityScore) ProtoReflect() protoreflect.Message {
	mi := &file_spark_tree_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FetchPolarityScore.ProtoReflect.Descriptor instead.
func (*FetchPolarityScore) Descriptor() ([]byte, []int) {
	return file_spark_tree_proto_rawDescGZIP(), []int{8}
}
...
type PolarityScores struct {
	...
	PolarityScore float32                `protobuf:"fixed32,3,opt,name=polarity_score,json=polarityScore,proto3" json:"polarity_score,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PolarityScores) Reset() {
	*x = PolarityScores{}
	mi := &file_spark_tree_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PolarityScores) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PolarityScores) ProtoMessage() {}

func (x *PolarityScores) ProtoReflect() protoreflect.Message {
	mi := &file_spark_tree_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PolarityScores.ProtoReflect.Descriptor instead.
func (*PolarityScores) Descriptor() ([]byte, []int) {
	return file_spark_tree_proto_rawDescGZIP(), []int{9}
}

func (x *PolarityScores) GetLeafId() string {
	if x != nil {
		return x.LeafId
	}
	return ""
...
func (x *PolarityScores) GetPublicKey() []byte {
	if x != nil {
		return x.PublicKey
	}
	return nil
...
func (x *PolarityScores) GetPolarityScore() float32 {
	if x != nil {
		return x.PolarityScore
	}
	return 0
}

type FetchPolarityScoreResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Scores        []*PolarityScores      `protobuf:"bytes,1,rep,name=scores,proto3" json:"scores,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *FetchPolarityScoreResponse) Reset() {
	*x = FetchPolarityScoreResponse{}
	mi := &file_spark_tree_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *FetchPolarityScoreResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FetchPolarityScoreResponse) ProtoMessage() {}

func (x *FetchPolarityScoreResponse) ProtoReflect() protoreflect.Message {
	mi := &file_spark_tree_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FetchPolarityScoreResponse.ProtoReflect.Descriptor instead.
func (*FetchPolarityScoreResponse) Descriptor() ([]byte, []int) {
	return file_spark_tree_proto_rawDescGZIP(), []int{10}
}

func (x *FetchPolarityScoreResponse) GetScores() []*PolarityScores {
	if x != nil {
		return x.Scores
	}
	return nil
...
var file_spark_tree_proto_rawDesc = string([]byte{
	...
	0x6f, 0x53, 0x77, 0x61, 0x70, 0x22, 0xa6, 0x01, 0x0a, 0x1f, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73,
	...
	,
	...
	0x57, 0x0a, 0x15, 0x66, 0x65, 0x74, 0x63, 0x68, 0x5f, 0x70, 0x6f, 0x6c, 0x61, 0x72, 0x69, 0x74,
	0x79, 0x5f, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x73, 0x12, 0x19, 0x2e, 0x73, 0x70, 0x61, 0x72, 0x6b,
	0x2e, 0x46, 0x65, 0x74, 0x63, 0x68, 0x50, 0x6f, 0x6c, 0x61, 0x72, 0x69, 0x74, 0x79, 0x53, 0x63,
	0x6f, 0x72, 0x65, 0x1a, 0x21, 0x2e, 0x73, 0x70, 0x61, 0x72, 0x6b, 0x2e, 0x46, 0x65, 0x74, 0x63,
	...
	0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x70, 0x61, 0x72, 0x6b, 0x5f, 0x74, 0x72, 0x65, 0x65, 0x62, 0x06,
...
var file_spark_tree_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_spark_tree_proto_goTypes = []any{
	...
	(*FetchPolarityScore)(nil),                // 8: spark.FetchPolarityScore
	(*PolarityScores)(nil),                    // 9: spark.PolarityScores
	(*FetchPolarityScoreResponse)(nil),        // 10: spark.FetchPolarityScoreResponse
	nil,                                       // 11: spark.GetLeafDenominationCountsResponse.CountsEntry
}
var file_spark_tree_proto_depIdxs = []int32{
	11, // 0: spark.GetLeafDenominationCountsResponse.counts:type_name -> spark.GetLeafDenominationCountsResponse.CountsEntry
	9,  // 1: spark.FetchPolarityScoreResponse.scores:type_name -> spark.PolarityScores
	0,  // 2: spark.SparkTreeService.get_leaf_denomination_counts:input_type -> spark.GetLeafDenominationCountsRequest
	2,  // 3: spark.SparkTreeService.find_leaves_to_give_user:input_type -> spark.FindLeavesToGiveUserRequest
	4,  // 4: spark.SparkTreeService.find_leaves_to_take_from_user:input_type -> spark.FindLeavesToTakeFromUserRequest
	6,  // 5: spark.SparkTreeService.propose_tree_denominations:input_type -> spark.ProposeTreeDenominationsRequest
	8,  // 6: spark.SparkTreeService.fetch_polarity_scores:input_type -> spark.FetchPolarityScore
	1,  // 7: spark.SparkTreeService.get_leaf_denomination_counts:output_type -> spark.GetLeafDenominationCountsResponse
	3,  // 8: spark.SparkTreeService.find_leaves_to_give_user:output_type -> spark.FindLeavesToGiveUserResponse
	5,  // 9: spark.SparkTreeService.find_leaves_to_take_from_user:output_type -> spark.FindLeavesToTakeFromUserResponse
	7,  // 10: spark.SparkTreeService.propose_tree_denominations:output_type -> spark.ProposeTreeDenominationsResponse
	10, // 11: spark.SparkTreeService.fetch_polarity_scores:output_type -> spark.FetchPolarityScoreResponse
