...
// Validate checks the field values on LockLeafForRenewalRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *LockLeafForRenewalRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on LockLeafForRenewalRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// LockLeafForRenewalRequestMultiError, or nil if none found.
func (m *LockLeafForRenewalRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *LockLeafForRenewalRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return LockLeafForRenewalRequestMultiError(errors)
	}

	return nil
}

// LockLeafForRenewalRequestMultiError is an error wrapping multiple validation
// errors returned by LockLeafForRenewalRequest.ValidateAll() if the
// designated constraints aren't met.
type LockLeafForRenewalRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m LockLeafForRenewalRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m LockLeafForRenewalRequestMultiError) AllErrors() []error { return m }

// LockLeafForRenewalRequestValidationError is the validation error returned by
// LockLeafForRenewalRequest.Validate if the designated constraints aren't met.
type LockLeafForRenewalRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e LockLeafForRenewalRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e LockLeafForRenewalRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e LockLeafForRenewalRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e LockLeafForRenewalRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e LockLeafForRenewalRequestValidationError) ErrorName() string {
	return "LockLeafForRenewalRequestValidationError"
}

// Error satisfies the builtin error interface
func (e LockLeafForRenewalRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sLockLeafForRenewalRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = LockLeafForRenewalRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = LockLeafForRenewalRequestValidationError{}
