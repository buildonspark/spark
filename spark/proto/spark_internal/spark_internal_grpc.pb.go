...
const (
	...
	SparkInternalService_LockLeafForRenewal_FullMethodName                 = "/spark_internal.SparkInternalService/lock_leaf_for_renewal"
...
type SparkInternalServiceClient interface {
	...
	LockLeafForRenewal(ctx context.Context, in *LockLeafForRenewalRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *sparkInternalServiceClient) LockLeafForRenewal(ctx context.Context, in *LockLeafForRenewalRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, SparkInternalService_LockLeafForRenewal_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SparkInternalServiceServer interface {
	...
	LockLeafForRenewal(context.Context, *LockLeafForRenewalRequest) (*emptypb.Empty, error)
...
func (UnimplementedSparkInternalServiceServer) LockLeafForRenewal(context.Context, *LockLeafForRenewalRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LockLeafForRenewal not implemented")
}
...
func _SparkInternalService_LockLeafForRenewal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LockLeafForRenewalRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SparkInternalServiceServer).LockLeafForRenewal(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SparkInternalService_LockLeafForRenewal_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SparkInternalServiceServer).LockLeafForRenewal(ctx, req.(*LockLeafForRenewalRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SparkInternalService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "lock_leaf_for_renewal",
			Handler:    _SparkInternalService_LockLeafForRenewal_Handler,
		},
		{
