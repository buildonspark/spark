...
var file_spark_internal_proto_rawDesc = []byte{
	...
	0x28, 0x0c, 0x52, 0x08, 0x65, 0x78, 0x69, 0x74, 0x54, 0x78, 0x69, 0x64, 0x32, 0xaf, 0x0a, 0x0a,
	...
	0x53, 0x77, 0x61, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x6f,
...
var file_spark_internal_proto_goTypes = []any{
	...
	(*common.SigningResult)(nil),                  // 25: common.SigningResult
	(*spark.AggregateNodesRequest)(nil),           // 26: spark.AggregateNodesRequest
	(*spark.InitiatePreimageSwapRequest)(nil),     // 27: spark.InitiatePreimageSwapRequest
...
var file_spark_internal_proto_depIdxs = []int32{
	...
	22, // 11: spark_internal.PrepareTreeAddressResponse.signatures:type_name -> spark_internal.PrepareTreeAddressResponse.SignaturesEntry
	24, // 12: spark_internal.InitiateTransferRequest.expiry_time:type_name -> google.protobuf.Timestamp
	...
	23, // 15: spark_internal.SigningJob.CommitmentsEntry.value:type_name -> common.SigningCommitment
	25, // 16: spark_internal.FrostRound2Response.ResultsEntry.value:type_name -> common.SigningResult
	...
	26, // 23: spark_internal.SparkInternalService.aggregate_nodes:input_type -> spark.AggregateNodesRequest
	...
	27, // 26: spark_internal.SparkInternalService.initiate_preimage_swap:input_type -> spark.InitiatePreimageSwapRequest
	...
	28, // 30: spark_internal.SparkInternalService.mark_keyshares_as_used:output_type -> google.protobuf.Empty
	...
	28, // 32: spark_internal.SparkInternalService.finalize_tree_creation:output_type -> google.protobuf.Empty
	...
	28, // 35: spark_internal.SparkInternalService.prepare_split_keyshares:output_type -> google.protobuf.Empty
	...
	13, // 39: spark_internal.SparkInternalService.initiate_preimage_swap:output_type -> spark_internal.InitiatePreimageSwapResponse
	16, // 40: spark_internal.SparkInternalService.prepare_tree_address:output_type -> spark_internal.PrepareTreeAddressResponse
	28, // 41: spark_internal.SparkInternalService.initiate_transfer:output_type -> google.protobuf.Empty
	28, // 42: spark_internal.SparkInternalService.initiate_cooperative_exit:output_type -> google.protobuf.Empty
