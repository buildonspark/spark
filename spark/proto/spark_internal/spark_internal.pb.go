...
var file_spark_internal_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x4c, 0x65, 0x61, 0x66, 0x52, 0x06, 0x6c, 0x65, 0x61, 0x76, 0x65, 0x73, 0x32, 0xc8,
	0x09, 0x0a, 0x14, 0x53, 0x70, 0x61, 0x72, 0x6b, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c,
...
var file_spark_internal_proto_goTypes = []any{
	...
	(*common.SigningResult)(nil),                  // 24: common.SigningResult
	(*spark.AggregateNodesRequest)(nil),           // 25: spark.AggregateNodesRequest
	(*spark.InitiatePreimageSwapRequest)(nil),     // 26: spark.InitiatePreimageSwapRequest
...
var file_spark_internal_proto_depIdxs = []int32{
	...
	23, // 8: spark_internal.FinalizeTransferRequest.timestamp:type_name -> google.protobuf.Timestamp
	...
	21, // 11: spark_internal.PrepareTreeAddressResponse.signatures:type_name -> spark_internal.PrepareTreeAddressResponse.SignaturesEntry
	23, // 12: spark_internal.InitiateTransferRequest.expiry_time:type_name -> google.protobuf.Timestamp
	17, // 13: spark_internal.InitiateTransferRequest.leaves:type_name -> spark_internal.InitiateTransferLeaf
	22, // 14: spark_internal.SigningJob.CommitmentsEntry.value:type_name -> common.SigningCommitment
	24, // 15: spark_internal.FrostRound2Response.ResultsEntry.value:type_name -> common.SigningResult
	0,  // 16: spark_internal.SparkInternalService.mark_keyshares_as_used:input_type -> spark_internal.MarkKeysharesAsUsedRequest
	1,  // 17: spark_internal.SparkInternalService.mark_keyshare_for_deposit_address:input_type -> spark_internal.MarkKeyshareForDepositAddressRequest
	9,  // 18: spark_internal.SparkInternalService.finalize_tree_creation:input_type -> spark_internal.FinalizeTreeCreationRequest
	3,  // 19: spark_internal.SparkInternalService.frost_round1:input_type -> spark_internal.FrostRound1Request
	6,  // 20: spark_internal.SparkInternalService.frost_round2:input_type -> spark_internal.FrostRound2Request
	8,  // 21: spark_internal.SparkInternalService.prepare_split_keyshares:input_type -> spark_internal.PrepareSplitKeysharesRequest
	25, // 22: spark_internal.SparkInternalService.aggregate_nodes:input_type -> spark.AggregateNodesRequest
	10, // 23: spark_internal.SparkInternalService.finalize_nodes_aggregation:input_type -> spark_internal.FinalizeNodesAggregationRequest
	11, // 24: spark_internal.SparkInternalService.finalize_transfer:input_type -> spark_internal.FinalizeTransferRequest
	26, // 25: spark_internal.SparkInternalService.initiate_preimage_swap:input_type -> spark.InitiatePreimageSwapRequest
	15, // 26: spark_internal.SparkInternalService.prepare_tree_address:input_type -> spark_internal.PrepareTreeAddressRequest
	18, // 27: spark_internal.SparkInternalService.initiate_transfer:input_type -> spark_internal.InitiateTransferRequest
	27, // 28: spark_internal.SparkInternalService.mark_keyshares_as_used:output_type -> google.protobuf.Empty
	2,  // 29: spark_internal.SparkInternalService.mark_keyshare_for_deposit_address:output_type -> spark_internal.MarkKeyshareForDepositAddressResponse
	27, // 30: spark_internal.SparkInternalService.finalize_tree_creation:output_type -> google.protobuf.Empty
	4,  // 31: spark_internal.SparkInternalService.frost_round1:output_type -> spark_internal.FrostRound1Response
	7,  // 32: spark_internal.SparkInternalService.frost_round2:output_type -> spark_internal.FrostRound2Response
	27, // 33: spark_internal.SparkInternalService.prepare_split_keyshares:output_type -> google.protobuf.Empty
	27, // 34: spark_internal.SparkInternalService.aggregate_nodes:output_type -> google.protobuf.Empty
	27, // 35: spark_internal.SparkInternalService.finalize_nodes_aggregation:output_type -> google.protobuf.Empty
	27, // 36: spark_internal.SparkInternalService.finalize_transfer:output_type -> google.protobuf.Empty
	13, // 37: spark_internal.SparkInternalService.initiate_preimage_swap:output_type -> spark_internal.InitiatePreimageSwapResponse
	16, // 38: spark_internal.SparkInternalService.prepare_tree_address:output_type -> spark_internal.PrepareTreeAddressResponse
	27, // 39: spark_internal.SparkInternalService.initiate_transfer:output_type -> google.protobuf.Empty
