...
import { TokenPubkey, TransferOwnershipAnnouncement, Lrc20TransactionDto } from "@buildonspark/lrc20-sdk";
...
async function main() {
  ...
  let newOwner = address.fromBech32("tb1ppfwjeshkreeq9kl7tmj7wa638pj2kck0kc8zkq94r238nasejegqs6ptv3");
