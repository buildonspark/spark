...
export class TokenTransactionService {
     ...
     */
    updateTokenLeavesFromFinalizedTransaction(tokenLeaves, finalizedTokenTransaction) {
        if (finalizedTokenTransaction.tokenInput.$case === "transferInput") {
            finalizedTokenTransaction.tokenInput.transferInput.leavesToSpend.forEach((spentLeaf) => {
                const index = tokenLeaves.findIndex((leaf) => leaf.previousTransactionHash ===
        ...
        const finalizedTokenTransactionHash = hashTokenTransaction(finalizedTokenTransaction, false);
