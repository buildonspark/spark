...
return {
__typename: "WalletUser",wallet_user_id: obj.id,
...
`,
            variables: {id},
            constructObject: (data: unknown) => isObject(data) && "entity" in data && isObject(data.entity) ? WalletUserFromJson(data.entity) : null,
        }
    }
