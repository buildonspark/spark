...
export const RequestLightningReceiveOutputFromJson = (
  obj: any
): RequestLightningReceiveOutput => {
  return {
    requestId: obj["request_lightning_receive_output_request"].id,
  } as RequestLightningReceiveOutput;
};
export const RequestLightningReceiveOutputToJson = (
  obj: RequestLightningReceiveOutput
): any => {
  return {
