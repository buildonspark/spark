...
export const RequestLightningReceiveInputFromJson = (
  obj: any
  ...
  return {
    network:
      BitcoinNetwork[
        obj[
          "request_lightning_receive_input_network"
...
export const RequestLightningReceiveInputToJson = (
  obj: RequestLightningReceiveInput
): any => {
  return {
